...
<head>
    ...
    <title>:: My-Task:: Create Invoice</title>
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="emp-Components">
                        ...
                        <li><a class="ms-link active" href="loan.html"> <span>Loan</span></a></li>
                    </ul>
                </li>
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-Componentsone">
                        ...
                        <li><a class="ms-link active" href="create-invoice.html"><span>Create Invoice</span> </a></li>
                    </ul>
                </li>
                <li class="collapsed">
                              ...
                              <tbody>
                                ...
                                <tr class="item-row">
                                  ...
                                  <td class="description">
                                    <textarea>Monthly web updates for Pixelwibes (Nov. 1 - Nov. 30, 2021)</textarea>
                                  </td>
