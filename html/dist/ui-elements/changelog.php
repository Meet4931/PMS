...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/changelog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 12:59:07 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <title>:: My-Task:: Changelog</title>
        ...
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="changelog.html"><i class="icofont-edit"></i> <span>Changelog</span> <span
                        class="ms-auto small-14 fw-bold">V1.1.8</span></a></li>
            </ul>
        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-auto">
                        <a href="https://pixelwibes.com/" title="" class="btn btn-white border lift">Get Support</a>
                        <a href="https://pixelwibes.com/" title="" class="btn btn-primary border lift">Our Portfolio</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12 col-md-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.8</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–- July 17, 2024</span> 
                                    <ul class="ms-5">
                                        <li>Bootstrap 5.3.2 to Latest Update Bootstrap 5.3.3 </li> 
                                        <li>Jquery 3.6.4 to Latest Update Jquery 3.7.1 </li> 
                                        <li>Datatables.net 1.12.1 to Latest Update Datatables.net 1.13.11 </li> 
                                        <li>Fullcalendar 5.5.1 to Latest Update Fullcalendar 5.11.5 </li> 
                                        <li>Apexcharts 3.42.0 to Latest Update Apexcharts 3.50.0 </li>  
                                        <li>Design Bug Fixing</li> 
                                    </ul>
                                </div>
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.7</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Oct 30, 2023</span>
                                    <ul class="ms-5">
                                        <li>Add Template Settings Multicolor Option</li>
                                        <li>Bug Fixed For Darkmode</li>
                                    </ul>
                                </div>
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.6</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Sep 19, 2023</span>
                                    <ul class="ms-5">
                                        <li>Jquery 3.6.0 to Latest Update Jquery 3.6.4 </li>
                                        <li>Prismjs 1.25.0 to Latest Update Prismjs 1.29.0</li>
                                        <li>Grunt 1.3.0 to Latest Update Grunt 1.6.1</li>
                                        <li>Grunt 1.3.0 to Latest Update Grunt 1.6.1</li>
                                        <li>grunt-contrib-uglify 5.0.0 to Latest Update grunt-contrib-uglify 5.2.2</li>
                                        <li>grunt-sass 2.1.0 to Latest Update grunt-contrib-uglify 3.1.0</li>
                                        <li>Add NodeScss 9.0.0</li>
                                        <li>Apexcharts 3.35.5 to Latest Update Apexcharts 3.42.0</li>
                                        <li>Apexcharts 3.35.5 to Latest Update Apexcharts 3.42.0</li>
                                    </ul>
                                </div>
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.5</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Oct 08, 2022</span>
                                            
                                    <ul class="ms-5">
                                        <li>Apexcharts 3.29.0 to Latest Update Apexcharts": "^3.35.5"</li>
                                        <li>Datatables.net 1.10.22 to Latest Update datatables.net": "^1.12.1"</li>
                                        <li>New Pages Add.
                                            <ul>
                                                <li><a href="../create-invoice.html" title="Create Invoice" class="text-secondary text-decoration-underline">Create Invoice (Account)</a></li>
                                                <li><a href="../loan.html" title="Create Invoice" class="text-secondary text-decoration-underline">Loan page (Employees)</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.4</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Feb 10, 2022</span>
                                            
                                    <ul class="ms-5">
                                        <li>Datatables.net 1.10.22 to Latest Update datatables.net": "^1.10.25"</li>
                                        <li>New Pages Add.
                                            <ul>
                                ...
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.3</span></h6>
                                ...
                                <div class="pt-2">
                                    <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.2</span></h6>
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Aug 20, 2021</span>
                                    <ul class="ms-5">
                                ...
                                <div class="pt-2">
                                    ...
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- June 26, 2021</span>
                                    <ul class="ms-5">
                                ...
                                <div class="pt-2">
                                    ...
                                    <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- May 7, 2021</span>
                                    <ul class="ms-5">
