...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/documentation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 12:59:06 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <title>:: My-Task:: Documentation</title>
   ...
   <div class="sidebar px-4 py-4 py-md-5 me-0">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="../index-2.html" title="" class="btn btn-dark lift">Go to Dashboard</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3 pt-3 card" style="font-size: 16px;">
                            ...
                            <div class="card-body">
                                <p>This guide will help you get started with <strong class="text-secondary">my-Task</strong>! All the important stuff –&nbsp;compiling the source, file structure, build tools, file includes –&nbsp;is documented here, but should you have any questions, always feel free to reach out to <span class="text-muted">pixelwibes@gmail.com</span></p>
                                ...
                                <ul style="line-height: 28px;">
                                    <li>
                                        ...
                                        <ul class="mb-3">
                                            ...
                                            <li>
                                                <strong><i class="icofont-file-code color-light-orange  me-2"></i>Index.html</strong><span class="text-muted">- my-Task Html Template</span>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card lift">
                                            <div class="lift">
                                            <img src="../assets/images/document/menu-open.png" alt="menu-open" class="img-fluid">
                                            </div>
                                        </div>
    ...
    &lt;/div&gt;</code>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card lift">
                                            <div class="lift">
                                            <img src="../assets/images/document/menu-close.png" alt="menu-open" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="card-body px-0">
    ...
    &lt;/nav&gt;</code>
            ...
            &lt;/div&gt;</code>
                    ...
                    </div> <!-- Doc: my-Task Advantages  -->

                    <div class="col-12">
                        <div class="mb-3 pt-3 card">
                            <div class="card-header">
                                <h5 class="fw-bold"><i class="icofont-diamond me-2"></i>my-Task Template Credit</h5>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row justify-content-between align-items-center">
                                <div class="col">
                                    <p class="font-size-sm mb-0">© my-Task. <span class="d-none d-sm-inline-block">2021 Pixelwibes.</span></p>
                                </div>
                                <div class="col-auto">
